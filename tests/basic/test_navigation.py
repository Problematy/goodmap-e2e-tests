...
class TestNavigationBarForSmallDevices:
    ...
    def test_hamburger_menu_vertically_centered_with_logo(self, page: Page, device_name: str):
        """
    ...
    @pytest.mark.parametrize("device_name", list(MOBILE_DEVICES.keys()))
    def test_left_menu_visible_after_clicking_left_hamburger(self, page: Page, device_name: str):
        """
